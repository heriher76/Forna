      ...
      <div class="col-12">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center hero-text">
            ...
            <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Kami bersedia menerima kritik dan saran untuk kedepannya lebih baik lagi</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-4 ml-auto order-2" data-aos="fade-up">
        <ul class="list-unstyled">
          <li class="mb-3">
            ...
            <span>Dusun Bunter Desa Sukadana RT03 RW04 Kec.Cimanggung Kab.Sumedang Jawa Barat</span>
          </li>
          <li class="mb-3">
            <strong class="d-block mb-1">Phone</strong>
            <span>+62 89615266856</span>
          </li>
          <li class="mb-3">
            <strong class="d-block mb-1">Email</strong>
            <span>herhermawan007@gmail.com</span>
          </li>
        </ul>
      </div>
